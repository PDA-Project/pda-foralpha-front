...
export const Answer = () => {
  ...
  const fetchAnswer = async (quizIid) => {
    try {
      const response = await axios.get(`http://test2.shinhan.site/foralpha-service/point/quiz/answer?quizId=${quizIid}`)//(`${window.API_BASE_URL}/foralpha-service/point/quiz/answer?quizId=${quizIid}`);
            ...
            <div className="frame-2">
              <div className="frame-wrapper">
                <div className="frame-3">
                  <div className="text-wrapper-2">정답은 ‘{answerData.quiz_answer}’ 입니다.</div>
                  <p className="p">
